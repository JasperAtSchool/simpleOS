...
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/main.lua","./main.lua")
newload("creating ./libs/testos-ui/main.lua",11)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/testos-ui/main.lua","./libs/testos-ui/main.lua")
os.sleep(2)
--cobalt instalation
newload("creating ./libs/cobalt/init.lua",12)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/init.lua","./libs/cobalt/init.lua")
newload("creating ./libs/cobalt/lib/clasp.lua",13)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/clasp.lua","./libs/cobalt/lib/clasp.lua")
newload("creating ./libs/cobalt/lib/surface.lua",14)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/surface.lua","./libs/cobalt/lib/surface.lua")

newload("creating ./libs/cobalt/lib/modules/graphics/init.lua",15)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/modules/graphics/init.lua","./libs/cobalt/lib/modules/graphics/init.lua")
newload("creating ./libs/cobalt/lib/modules/keyboard/init.lua",16)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/modules/keyboard/init.lua","./libs/cobalt/lib/modules/keyboard/init.lua")
newload("creating ./libs/cobalt/lib/modules/mouse/init.lua",17)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/modules/mouse/init.lua","./libs/cobalt/lib/modules/mouse/init.lua")
os.sleep(2)

newload("creating ./libs/cobalt/lib/modules/graphics/classes/Canvas.lua",18)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/modules/graphics/classes/Canvas.lua","./libs/cobalt/lib/modules/graphics/classes/Canvas.lua")
newload("creating ./libs/cobalt/lib/modules/graphics/classes/Drawable.lua",19)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/modules/graphics/classes/Drawable.lua","./libs/cobalt/lib/modules/graphics/classes/Drawable.lua")
newload("creating ./libs/cobalt/lib/modules/graphics/classes/Image.lua",20)
shell.run("background","wget","https://raw.githubusercontent.com/DJj123dj/simpleOS/main/libs/cobalt/lib/modules/graphics/classes/Image.lua","./libs/cobalt/lib/modules/graphics/classes/Image.lua")
